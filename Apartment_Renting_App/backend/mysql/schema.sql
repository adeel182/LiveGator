DROP DATABASE IF EXISTS Team13_DBinstance;
CREATE DATABASE Team13_DBinstance;
USE Team13_DBinstance;
...
(1, 'Foster', 'House','This is my fantastic house in foster city',1200, 500, 15.4, 861, 'Sanbarra st', 'Foster City', 'CA', 94404, 'https://photos.zillowstatic.com/cc_ft_1536/ISmmvxzrdz55h91000000000.webp', 2, 2, 2, TRUE, NOW(), TRUE),
(2, 'South SF', 'Apartment','Beautiful brand new house in South SF with spacious bedroom', 1000, 300, 2.4, 181, 'Fremont st', 'San Francisco', 'CA', 94105, 'https://djs00nylhf7co.cloudfront.net/assets/img--gallery-interior-52_lg-277eb7b2a425cc901979eb40c134e9b4e3ffe13041dad29d15ec41a4ac35e1b9.jpg', 1, 1, 1, TRUE, NOW(), TRUE),
(2, 'Downtown SF', 'Condo','Room at the heat of SF', 1500, 500, 8, 201, 'Van Ness Ave', 'San Francisco', 'CA', 94102, 'https://www.sfsymphony.org/SanFranciscoSymphony/media/Press-Releases/Davies%20Hall/DSH-night.jpg?width=3149&height=2099&ext=.jpg', 2, 1.5, 2, FALSE, NOW(), TRUE);
